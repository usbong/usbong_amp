...
import usbong.android.amp.R;
import usbong.android.amp.UsbongDecisionTreeEngineActivity;
...
public class UsbongUtils {		
	...
	public static String DEFAULT_UTREE_TO_LOAD="amp"; //updated by Mike, 20160720
	public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory()+"/usbong_amp/";
	...
	public final static String myPackageName="usbong.android.amp";
	public static String myAppTreeFolder = "/usbong_amp/usbong_trees/";
	...
	public static void initUsbongConfigFile() {
        try 
        {
        	...
        	if (UsbongUtils.getFileFromSDCardAsReader(UsbongUtils.BASE_FILE_PATH + "usbong.config") == null) { 
				...
				UsbongUtils.IS_IN_AUTO_NARRATE_MODE=false; //edited by Mike, 20180527					
